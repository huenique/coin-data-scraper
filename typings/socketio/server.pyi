...
class Server(base_server.BaseServer):
    ...
    """
    def emit(self, event, data=..., to=..., room=..., skip_sid=..., namespace=..., callback=..., ignore_queue=...): # -> None:
    ...
    def send(self, data, to=..., room=..., skip_sid=..., namespace=..., callback=..., ignore_queue=...): # -> None:
    ...
    def call(self, event, data=..., to=..., sid=..., namespace=..., timeout=..., ignore_queue=...): # -> None:
    ...
    def disconnect(self, sid, namespace=..., ignore_queue=...): # -> None:
        """Disconnect a client.
    ...
    def instrument(self, auth=..., mode=..., read_only=..., server_id=..., namespace=..., server_stats_interval=...): # -> InstrumentedServer:
